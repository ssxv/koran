...
const transitions: TransitionsMap = {
    melt: { from: WaterStatus.solid, to: WaterStatus.liquid },
    vapourize: { from: WaterStatus.liquid, to: WaterStatus.gas },
    condense: { from: WaterStatus.gas, to: WaterStatus.liquid },
};
